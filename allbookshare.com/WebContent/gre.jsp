		...
		<div id="newProductCar" class="carousel slide">
			...
			<div class="item active">
			  <ul class="thumbnails">
				<li class="span3">
				<div class="thumbnail">
					<img src="assets/img/gr1.jpg" alt="">
				</div>
				</li>
				<li class="span3">
				  <div class="thumbnail">
					<img src="assets/img/gr2.jpg" alt="">
				  </div>
				</li>
				<li class="span3">
				  <div class="thumbnail">
				<img src="assets/img/gr3.jpg" alt="">
				  </div>
				</li>
				<li class="span3">
				  <div class="thumbnail">
					<img src="assets/img/gr4.jpg" alt="">
				  </div>
				</li>
			  </ul>
			  </div>
		  ...
		  <ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="assets/img/gr5.jpg" alt="">
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
			...
			<li class="span3">
			  <div class="thumbnail">
				<img src="assets/img/gr7.jpg" alt="">
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
