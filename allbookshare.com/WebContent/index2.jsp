		...
		<div class="container">
		  ...
		  <div class="nav-collapse">
			<ul class="nav">
			  ...
			  <li class=""><a href="list-view.html">GET BOOKS</a></li>
			  <li class=""><a href="grid-view.html">SELL BOOKS</a></li>
			  <li class=""><a href="three-col.html">READ ONLINE</a></li>
			  <li class=""><a href="four-col.html">BLOG</a></li>
			...
			<li class="dropdown">
				...
				<form class="form-horizontal loginFrm" action="validate" method="post">
				  <div class="control-group">
					<input type="text" class="span2" id="inputEmail" placeholder="Email" name="emailid">
				  </div>
				  <div class="control-group">
...
<div class="well well-small">
	<ul class="nav nav-list">
		<li><a href="products.html"><span class="icon-chevron-right"></span>IIT-JEE BOOKS</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>GATE BOOKS</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>GRE BOOKS</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>CAT BOOKS</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>BTECH BOOKS</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>MISCELLANEOUS BOOKS</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>NOVELS</a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>RELIGIOUS BOOKS </a></li>
		<li><a href="products.html"><span class="icon-chevron-right"></span>MAGAZINES</a></li>
...
<div class="span2">
<h5>INFORMATION</h5>
<a href="contact.html">PRIVACY POLICIES</a><br>
<a href="#">SITEMAP</a><br>
...
<div class="span2">
<h5>Our Offer</h5>
<a href="#">NEW BOOKS</a> <br>
<a href="#">TOP BOOKS</a><br>
