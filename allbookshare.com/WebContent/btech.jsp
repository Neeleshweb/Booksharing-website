		...
		<div id="newProductCar" class="carousel slide">
			...
			<div class="item active">
			  <ul class="thumbnails">
				...
				<li class="span3">
				  <div class="thumbnail">
					<img src="assets/img/en3.jpg" alt="">
				  </div>
				</li>
				<li class="span3">
				  <div class="thumbnail">
					<img src="assets/img/en4.jpg" alt="">
				  </div>
				</li>
			  </ul>
			  </div>
		  ...
		  <ul class="thumbnails">
			<li class="span3">
			  <div class="thumbnail">
				<img src="assets/img/en5.jpg" alt="">
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="assets/img/en6.jpg" alt="">
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="assets/img/en7.jpg" alt="">
			  </div>
			</li>
			<li class="span3">
			  <div class="thumbnail">
				<img src="assets/img/en8.jpg" alt="">
			  </div>
			</li>
		  </ul>
		  </div>
		  ...
		  <ul class="thumbnails">
			<li class="span4">
			  <div class="thumbnail">
				...
				<img src="assets/img/en9.jpg" alt="">
